...
public class BagItem extends Item implements PolymerItem {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        if (user.isSneaking()) {
            ...
            user.sendMessage(Text.translatable("redstonepacks.pickup_mode", Text.translatable("redstonepacks.pickup_mode." + pickupMode.asString().toLowerCase())));
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        ...
        tooltip.add(Text.translatable("redstonepacks.pickup_mode", Text.translatable("redstonepacks.pickup_mode." + pickupMode.asString().toLowerCase())).formatted(Formatting.GRAY));
        tooltip.add(Text.translatable("redstonepacks.tooltip.cycle_pickup_mode").formatted(Formatting.DARK_GRAY));
    }
